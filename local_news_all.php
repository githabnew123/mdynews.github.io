...
<body>
    ...
    <h1 class="news-heading"  style="margin-top: 200px;">Myanmar</h1>
<?php
  $data = get_local_news();
  $limit = 4;
  $x = sizeof($data);
...
?>
  ...
  <p class="page-switch-paragraph">
      <a href="local_news_all.php?limit=<?php echo ($_GET['limit']-1); ?>"><button class="btn btn-outline-dark font-size" type="button" name="button"> < </button></a>
